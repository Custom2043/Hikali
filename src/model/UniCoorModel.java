...
public class UniCoorModel extends Model
{
	public UniCoorModelPart[] parts;
	
	public UniCoorModel(UniCoorModelPart p, Texture text) {this(new UniCoorModelPart[]{p}, text);}
	public UniCoorModel(UniCoorModelPart[] p, Texture text) {
		super(p.length*4);
		texture = text;
	...
	public void storeDatas() 
	{
		...
		for (UniCoorModelPart gmp : parts)
